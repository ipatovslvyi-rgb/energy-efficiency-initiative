    ...
    <div className="relative min-h-screen text-foreground">
      ...
      <nav className="sticky top-0 z-40 border-b border-foreground/10 bg-background/90 backdrop-blur-md">
        <div className="mx-auto flex max-w-7xl items-center gap-4 px-6 py-3 md:px-10">
          ...
          <div>
            <h1 className="font-sans text-base font-medium text-foreground">Справочник</h1>
            <p className="font-mono text-xs text-foreground/40">Нормативные значения для расчётов</p>
          </div>
        </div>
      </nav>
